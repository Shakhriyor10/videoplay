...
TEXTS = {
    "ru": {
        ...
        "preparing": "⏳ Готовлю медиа для стабильного воспроизведения…",
        ...
        "search_failed": "⚠️ Источник временно недоступен. Попробуйте другую песню, прямую ссылку или повторите позже.",
    ...
    "uz": {
        ...
        "preparing": "⏳ Barqaror ijro uchun media tayyorlanmoqda…",
        ...
        "search_failed": "⚠️ Manba vaqtincha ishlamayapti. Boshqa qo'shiqni, to'g'ridan-to'g'ri havolani yuboring yoki keyinroq urinib ko'ring.",
    ...
    "en": {
        ...
        "preparing": "⏳ Preparing media for stable playback…",
        "assistant_join_failed": "⚠️ {reason}\n\nGrant the bot permission to invite users.",
        "not_found": "🔎 Nothing was found. Refine the title or send a direct YouTube link.",
        "search_failed": "⚠️ The source is temporarily unavailable. Try another track, a direct link, or try again later.",
